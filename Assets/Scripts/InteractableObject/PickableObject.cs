...
public class PickableObject : MonoBehaviour
{
    ...
    [SerializeField] private BoxCollider2D groundBounceCollider;
    [SerializeField] private BoxCollider2D playerPickableTriggerCollider;

    [Header("Item Drop")]
    [SerializeField] private Vector2 dropForce = new Vector2(3, 10);
    [SerializeField] private float rotationSpeed = 360f;
    [SerializeField] private float rotationDamping = 3f;
    [SerializeField] private Vector2 initialRotationAngleRange = new Vector2(0f, 45f);

    [Header("Settle (落地判定)")]
    [SerializeField] private LayerMask groundMask;
    [SerializeField] private float minSettleSpeed = 0.1f;
    [SerializeField] private float freezeDelay = 0.1f;
    [SerializeField] private float settleExtraDelay = 0.05f;
    ...
    public void SetupObject(ItemDataSO data, bool facingRight)
    {
        ...
        sr.transform.localScale = new Vector3(
            1 / (baseScaleMultiplier * bonusScaleMultiplier),
            1 / (baseScaleMultiplier * bonusScaleMultiplier),
            1);
        ...
        playerPickableTriggerCollider.enabled = false;
    }
    ...
    private IEnumerator SettleCo()
    {
        ...
        playerPickableTriggerCollider.enabled = true;
